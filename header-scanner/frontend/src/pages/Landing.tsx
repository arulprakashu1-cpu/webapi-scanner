          ...
          <section style={{ padding: '0 24px 64px' }}>
            <div style={{ maxWidth: '820px', margin: '0 auto', background: '#161B22', border: '1px solid rgba(255,255,255,0.07)', borderRadius: '8px', padding: '36px 32px', textAlign: 'center' }}>
              ...
              <div style={{ display: 'flex', justifyContent: 'center', gap: '8px', flexWrap: 'wrap' }}>
                ...
                <a href="http://localhost:5173/register" style={{ display: 'inline-flex', alignItems: 'center', gap: '6px', fontSize: '13px', fontWeight: 600, padding: '9px 20px', borderRadius: '6px', textDecoration: 'none', background: 'rgba(255,255,255,0.05)', color: '#8B949E', border: '1px solid rgba(255,255,255,0.08)' }}>
      ...
      <footer style={{ marginTop: 'auto', borderTop: '1px solid rgba(255,255,255,0.05)', padding: '16px 32px' }}>
        <div style={{ maxWidth: '1100px', margin: '0 auto', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '10px' }}>
          ...
          <div style={{ display: 'flex', gap: '16px' }}>
            ...
            <a href="http://localhost:5173" style={{ fontSize: '12px', color: '#484F58', textDecoration: 'none' }}>Pro API</a>
          </div>
        </div>
      </footer>
    </div>
